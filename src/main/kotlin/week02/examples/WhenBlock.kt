...
// 블록을 사용한 복잡한 when 처리
fun complexWhen(input: String) : String {
    when (input.lowercase()) {
        ...
        in listOf("help", "도움말", "?") -> {
            ...
            return "'help'를 입력하면 사용법을 확인할 수 있습니다."
        }
    }
}

// when 표현식과 블록의 조합
fun getSystemStatus(status: String): String = "test"
...
fun main() {
    ...
    // 여러 명령어 테스트
    println(complexWhen("start"))
    println()

    println(complexWhen("help"))
    println()


    println(complexWhen("unknown"))
